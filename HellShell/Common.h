//The problem with this header file in the implementation pulled from https://github.com/NUL0x4C/HellShell/tree/main is that the Common.h header is also included in other .c/.cpp files, creating problems for the linker at build time. The tool was since rewritten by the authors in a tidier way with the full functions
//left out of Common.h and without individual header files for the various encryption methods, resolving build issues
